...
import com.jlab.common.{Version, Time, genericProcessor}
import com.jlab.encoding.Encoding
import com.jlab.process.Data
import configuration.Config
import org.apache.http.HttpHost
import org.apache.http.client.methods.{HttpUriRequest, HttpGet}
import org.apache.http.conn.params.ConnRoutePNames
import org.apache.http.protocol.{ExecutionContext, BasicHttpContext}
...
class HttpFetcher(config: Config,
  ...
  def process(d: Data): Data = {
    ...
    val out = List[(String, String)](("fetch_version", Version.versionString),
    ...
    val compress = d.getOption("fetch_compress") match {
