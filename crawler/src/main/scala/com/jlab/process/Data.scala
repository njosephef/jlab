...
class Data(m: Map[String, JValue]) {
  ...
  */
  ...
  def toJson(): String = {
    ...
    net.liftweb.json.compact(render(JObject(m)))
  }
...
object Data {
  def empty(): Data = {
    new Data(scala.collection.immutable.Map.empty)
  }
  ...
  def fromJson(js: String): Data = {
    fromAST(net.liftweb.json.parse(js))
  }
